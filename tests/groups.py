...
import testutils
from oftest.cstruct import OFPST_GROUP_DESC
...
class GroupTest(basic.SimpleDataPlane):
    ...
    def clear_switch(self):
        testutils.delete_all_flows(self.controller, group_logger)
        testutils.delete_all_groups(self.controller, group_logger)
...
class GroupStatsAll(GroupTest):
    ...
    def runTest(self):
        ...
        flow_add_msg2 = \
        create_flow_msg(packet = packet_in, in_port = 2, apply_action_list = [
...
class GroupFlowSelect(GroupTest):
    ...
    def runTest(self):
        ...
        aggr_stat_req.match.dl_src_mask= [0xff, 0xff, 0xff, 0xff, 0xff, 0xff]
